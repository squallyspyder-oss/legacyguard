...
import { X, Shield, Zap, HardDrive, Database, DollarSign, Info, Check, User, Bell, Keyboard, Settings2, Moon, Sun, Monitor } from "lucide-react"
...
export default function SettingsPanel({ isOpen, onClose, settings, onUpdateSettings }: SettingsPanelProps) {
  ...
  const tabs = [
    ...
    { id: "data" as const, label: "Dados", icon: <HardDrive className="w-4 h-4" /> },
  ]
